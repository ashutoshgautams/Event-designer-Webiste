      ...
      <div className="container">
        <div className={styles.contentGrid}>
          <div className={styles.column}>
            ...
            <p className={styles.description}>
              Creating luxurious moments and timeless memories for every celebration. The epitome of elegant event design in Bihar, India.
            </p>
            <ul className={styles.socialList}>
              <li className={styles.socialItem}>
                <a 
                  href="https://www.instagram.com/khushiyaan025/" 
                  target="_blank" 
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              ...
              <li className={styles.linkItem}>
                <Link href="#themes">Collections</Link>
              </li>
              <li className={styles.linkItem}>
        ...
        <div className={styles.bottom}>
          <div className={styles.bottomLinks}>
            ...
            <Link href="#" className={styles.bottomLink}>Cookie Policy</Link>
          </div>
          <p>&copy; {new Date().getFullYear()} Khushiyaan Events. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
